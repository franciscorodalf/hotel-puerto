...
@WebService(name = "GuestSoapService", targetNamespace = "http://hotel.docencia.org/ws")
public interface GuestSoapService {
    ...
    @WebResult(name = "guest")
    Guest deleteById(@WebParam(name = "guest") Long id);

    @WebMethod(operationName = "UpdateGuest")
    @WebResult(name = "guest")
    Guest updateGuest(@WebParam(name = "guest") Guest guest);
}
